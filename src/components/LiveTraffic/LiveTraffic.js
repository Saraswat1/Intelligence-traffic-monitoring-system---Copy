...
export default class LiveTraffic extends Component {
  ...
  static defaultProps = {
    center: { lat: 22.5788545, lng: 88.4716628},
    zoom: 18
  };
  constructor(){
    super()
  ...
  render() {
    return (
      ...
      <div> {this.state.countdown} </div>
        ...
        <Trafficlight color={this.state.l1} count={this.state.c1}   lat={22.578436} lng={88.471650} />
        <Trafficlight color={this.state.l2} count={this.state.c2} lat={22.579173} lng={88.471789} />
        <Trafficlight color={this.state.l3} count={this.state.c3} lat={ 22.578485}lng={88.472186} />
        <Trafficlight color={this.state.l4} count={this.state.c4} lat={ 22.578732} lng={88.470657} />
        <Trafficlight color={this.state.l1} count={this.state.c1}   lat={22.585633} lng={88.422458} />
        <Trafficlight color={this.state.l2} count={this.state.c2+2} lat={22.585345} lng={88.421840} />
        <Trafficlight color={this.state.l3} count={this.state.c3} lat={ 22.585335}lng={88.422179} />
        <Trafficlight color={this.state.l4} count={this.state.c4+2} lat={22.585796} lng={88.421819} />
         <Trafficlight color={this.state.l1} count={this.state.c1} lat={22.557501} lng={88.412116} />
        <Trafficlight color={this.state.l2} count={this.state.c2+1} lat={22.557999} lng={88.411503} /> 
        <Trafficlight color={this.state.l3} count={this.state.c3+2} lat={22.557545} lng={88.411896} /> 
        <Trafficlight color={this.state.l4} count={this.state.c4+2} lat={22.558033}lng={88.412125}/>
        <Trafficlight color={this.state.l1} count={this.state.c1+2} lat={22.623725}lng={ 88.440836}/>
        <Trafficlight color={this.state.l2} count={this.state.c2+2} lat={22.623869}lng={ 88.441333}/>
        <Trafficlight color={this.state.l3} count={this.state.c3+2} lat={22.623441} lng={88.441318}/>
        <Trafficlight color={this.state.l4} count={this.state.c4+2} lat={22.623406 } lng={88.440695}/>
